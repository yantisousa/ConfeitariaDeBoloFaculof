...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($conexao, "INSERT INTO dados_users(nome, email, senha)VALUES ('$nome', '$email', '$senha')");
    ...
    <div class="form-login">
        <div class="form-style">
            ...
            <form action="cadastro.php" method="POST">
                <input type="text" placeholder="Digite seu nome completo" name="nome"><br>
                <input type="text" name="email" placeholder="Email" required><br>
                <input type="password" name="senha" placeholder="Senha" required><br>
                <input class="submit-1" type="submit" name="submit" value="Enviar">
                <br><br><br>
                <hr>
